...
public:
     ...
     */
    void setVelocidadViento(long int sensorVel) {
        long int vel=0;
     ...
     */
    void setDireccionViento(int sensorDir) {
     ...
     */
    void setRadiacion(long int sensorRad) {
     ...
     */
    void setTemperatura(SFE_BMP180 bmp180i) {
        char status;
        double temperatura;
     ...
     */
    void setPresion(SFE_BMP180 bmp180i){
        double presion;
     ...
     */
    void cuentaPulsos (long int pulsos) {
