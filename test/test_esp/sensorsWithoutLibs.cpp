...
void testSetwindDirection() {
    weatherStation.setwindDirection(100);
    TEST_ASSERT_EQUAL_INT((100 * 3.3 * 72.7) / 2978,weatherStation.getWindDirection());

    weatherStation.setwindDirection(200);
    TEST_ASSERT_EQUAL_INT((200 * 3.3 * 72.7) / 2978,weatherStation.getWindDirection());

    weatherStation.setwindDirection(300);
    TEST_ASSERT_EQUAL_INT((300 * 3.3 * 72.7) / 2978,weatherStation.getWindDirection());
